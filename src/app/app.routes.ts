...
export const routes: Routes = [
    ...
    // services
    {path: "services/create", loadComponent: () => import("./components/businessservices/create/create").then(m=>m.Create)},
    {path: "services/delete", loadComponent: () => import("./components/businessservices/delete/delete").then(m=>m.Delete)},
    {path: "services/detail-by-owner", loadComponent: () => import("./components/businessservices/detail-by-owner/detail-by-owner").then(m=>m.DetailByOwner)},
    {path: "services/detail-by-user", loadComponent: () => import("./components/businessservices/detail-by-user/detail-by-user").then(m=>m.DetailByUser)},
    {path: "services/list-by-owner", loadComponent: () => import("./components/businessservices/list-by-owner/list-by-owner").then(m=>m.ListByOwner)},
    {path: "services/list-by-user", loadComponent: () => import("./components/businessservices/list-by-user/list-by-user").then(m=>m.ListByUser)},
    // reservation 
